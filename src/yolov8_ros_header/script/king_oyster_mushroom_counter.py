...
model = YOLO('/home/esdl/feng_ws/src/yolov8_ros_header/weights/count_mushrooms.pt')
...
def image_callback(msg):
    ...
    for prediction in predictions:
        ...
        if class_name == 'King_oyster_mushroom':
            ...
            # Draw bounding box
            # x1, y1, x2, y2 = prediction['box']['x1'], prediction['box']['y1'], prediction['box']['x2'], prediction['box']['y2']
    ...
    # Display the count at the top-left corner
    cv2.putText(image_b4_color, 'Count: %d' % count, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
